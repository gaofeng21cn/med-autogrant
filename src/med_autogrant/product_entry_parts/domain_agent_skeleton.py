        ...
        "repo_source_boundary": {
            "agent": {
                ...
                "source_refs": [
                    ...
                    "agent/professional_skills/mag-call-fit-analyst/SKILL.md",
                    "agent/professional_skills/mag-fundability-strategist/SKILL.md",
                    "agent/professional_skills/mag-grant-strategy-memory-curator/SKILL.md",
                    "agent/professional_skills/mag-specific-aims-architect/SKILL.md",
                    "agent/professional_skills/mag-proposal-section-author/SKILL.md",
                    "agent/professional_skills/mag-grant-reviewer/SKILL.md",
                    "agent/professional_skills/mag-rebuttal-planner/SKILL.md",
                    "agent/professional_skills/mag-submission-package-auditor/SKILL.md",
