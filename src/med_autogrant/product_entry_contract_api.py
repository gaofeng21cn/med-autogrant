...
build_author_side_route_contract = _build_author_side_route_contract
build_executor_routing_contract = _build_executor_routing_contract
build_operator_contract = _build_operator_contract
build_runtime_state_contract = _build_runtime_state_contract
build_runtime_substrate_contract = _build_runtime_substrate_contract
read_current_program_contract = _read_current_program_contract
