...
- 产品 frontdesk 面：`product-frontdesk` 现在会把 grant shell 上方的 controller-owned direct frontdoor 冻结成 machine-readable frontdesk contract，并由 `product-frontdesk.schema.json` 保持 fail-closed。
