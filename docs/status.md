...
- 不能把 production acceptance tail 写成 live stage progress owner answer；当前 live progress source of truth 是 `contracts/live_stage_run_progress_evidence.json`，且状态为 MAG-owned typed blocker。
