...
- Tests-only：当前 `tests/**` 为 `8,808` 行；相对严格基线 `20,261` 行减少 `11,453`，相对本任务 main 基线 `17,692` 行减少 `8,884`。
- Path-filtered diff：`tests/** +410 / -9,294 / net -8,884`。`src/**`、`contracts/**`、schemas、docs 与 README 的删除不计入 tests-only 收益。
