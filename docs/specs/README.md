...
- `absorbed_support`：只在仍支撑当前 schema、product-entry、package/export、executor routing 或 handoff 的 subsection 内阅读；旧 provider、Gateway、federation、local runtime、flat shell alias、compatibility facade 或 patch bridge 语义不得恢复为当前 owner。
