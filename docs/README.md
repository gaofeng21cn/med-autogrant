...
- Product frontdesk surface: `product-frontdesk` now freezes the controller-owned direct front door above the grant shell into one machine-readable frontdesk contract, and it is now fail-closed by `product-frontdesk.schema.json`.
