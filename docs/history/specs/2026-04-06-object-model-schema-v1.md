...
Purpose: `historical_foundation_schema_v1_provenance`
State: `history`
Machine boundary: 本文是人读历史 spec，保留 2026-04-06 对象模型、NSFC workspace 聚合根与早期 schema V1 形成过程。当前 schema registry、contract source、workspace semantics、active specs 与机器行为以核心五件套、`docs/specs/README.md`、`docs/specs/specs_lifecycle_map.md`、contracts、schemas、source、CLI/API 行为与 `contracts/runtime-program/current-program.json` 为准。
