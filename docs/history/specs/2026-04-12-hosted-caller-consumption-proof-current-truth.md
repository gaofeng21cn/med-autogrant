...
Purpose: `historical_hosted_caller_contract_consumption_provenance`
State: `history`
Machine boundary: 本文是人读历史 spec，保留 2026-04-12 hosted caller 消费 domain/schema/authoring contracts 的证明过程。当前 OPL provider、App/workbench、production/default caller、grant readiness 与机器行为以核心五件套、`docs/specs/README.md`、`docs/specs/specs_lifecycle_map.md`、contracts、schemas、source、CLI/API 行为与 `contracts/runtime-program/current-program.json` 为准。
