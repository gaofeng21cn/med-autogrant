...
Purpose: `historical_authoring_flow_p2c_provenance`
State: `history`
Machine boundary: 本文是人读历史 spec，保留 2026-04-07 drafting、critique、revision skeleton、re-review route 与 early audit surface 形成过程。当前 draft/critique/revision route truth、authoring pass、executor boundary、OPL/Temporal runtime owner 与机器行为以核心五件套、`docs/specs/README.md`、`docs/specs/specs_lifecycle_map.md`、contracts、schemas、source、CLI/API 行为与 `contracts/runtime-program/current-program.json` 为准。
