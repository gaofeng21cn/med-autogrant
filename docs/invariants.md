...
- StageRunController 只能物化 identity-bound `opl_stage_review_receipt`。任何本地 submission-ready 投影必须同时消费 current scoped evidence、独立 exact-byte release integrity 与 MAG-owned export/owner verdict；reviewer 与 OPL 均不得签 MAG owner receipt 或授权 export/submission readiness。
