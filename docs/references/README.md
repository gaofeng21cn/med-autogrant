...
不再解释当前边界的历史/provider-specific handoff 说明已移入 [历史归档](../history/README.md)。旧 OPL Runtime Manager 三层说明和旧 lightweight product-entry handoff 说明现在位于 `docs/history/`，因为其中仍有效的当前内容已被核心文档、`OPL Family Contract Adoption` 与 specs lifecycle map 吸收。
...
- [系列项目文档治理清单](./governance/series-doc-governance-checklist.md)：说明 MAG 文档如何按当前 OPL series 六仓 scope、同名 docs taxonomy 和 MAG grant-authority 边界做巡检。MAG 文档生命周期治理规则读 [MAG 文档组合治理](../docs_portfolio_consolidation.md)。
