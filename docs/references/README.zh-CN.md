...
- [Med Auto Grant 理想目标态](./med-auto-grant-ideal-state.zh-CN.md)：说明 MAG 作为 OPL-compatible grant domain agent 的 north-star 目标态，以及 app skill、domain package、OPL hosted path、workspace/runtime artifact root 之间的 owner 边界。
