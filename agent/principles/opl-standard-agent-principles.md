...
This projection does not create a second truth source. OPL owns the shared principle vocabulary; MAG owns grant truth, fundability and quality/export verdicts, package authority, grant strategy memory accept/reject decisions, and owner receipts.

| Principle id | Principle | Domain adoption meaning |
| --- | --- | --- |
| `ai_first_execution` | AI-first execution | AI performs open-ended grant understanding, comparison, strategy, drafting, review, diagnosis, and revision inside bounded stage attempts. |
...
| `domain_truth_authority` | Domain truth authority | Grant truth, fundability/export verdicts, package authority, memory body, owner receipts, and typed blockers stay with MAG. |
| `stage_prompt_skill_tool_separation` | Prompt / Skill / Tool separation | Stage prompts define goals and accepted answer shapes; professional skills carry grant methods; tool catalogs describe affordances and limits. |
...
For MAG, these ids are adopted through the grant-specific specialization in `agent/principles/domain-specialization.md` and the mapping contract in `contracts/standard-agent-principles-adoption.json`.
