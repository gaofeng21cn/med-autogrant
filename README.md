...
- `product frontdesk`: `product-frontdesk` now lands the controller-owned direct front door above the same shell, while the actual operator loop still lives in `grant-user-loop`
