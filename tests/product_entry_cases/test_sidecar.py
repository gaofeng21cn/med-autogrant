...
class ProductSidecarTest(unittest.TestCase):
    def test_sidecar_export_maps_runtime_and_attention_surfaces_without_grant_truth_transfer(self) -> None:
        ...
        self.assertIn("generic_artifact_gallery_owner", thinning["forbidden_mag_generic_owner_roles"])
        self.assertIn("generic_observability_slo_owner", thinning["forbidden_mag_generic_owner_roles"])
        ...
        self.assertEqual(conflict_projection, thinning["opl_family_conflict_blocker_projection"])
        self.assertEqual(conflict_projection["projection_policy"], "typed_blocker_only_no_fallback_completion")
        self.assertFalse(conflict_projection["authority_boundary"]["can_write_domain_truth"])
        ...
        self.assertEqual(observability, thinning["opl_runtime_observability_consumption"])
